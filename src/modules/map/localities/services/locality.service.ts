...
// Local
import { CreateMapLocalityDto, IOsmResponse } from '../dtos';
import { Locality } from '../entities/locality.entity';
// Modules
import { MapCoordinate, MapPositionsService } from '@modules/map/positions';
/**
 * Locality service
 */
@Injectable()
export class LocalityService {
  ...
  async getByCoordinates(_p: MapCoordinate): Promise<Locality> {
    const locality = await this.repo.findOne();
    // TODO: Write geByCoordinates
